...
# Local imports
from commands.utilities import bold, get_randomselect_data # Bring in some utilities to help the process
...
def help(command):
    ...
    help_commands = {
        'fgc-rs-github': 'For more information about the bot and its commands; <https://github.com/nogarremi/fgc-random-select-bot>',
        'fgc-rs-help': 'Usage: /fgc-rs-help {command}',
        'ping': 'Check if bot is online',
        'random-select': 'Return a randomly selected character from the game in the argument. Also supports stages for Lethal League Blaze and Tekken 7'
    }
